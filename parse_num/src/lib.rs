...
pub fn parse_num_mask_padded<T: ToString + Clone>(
    ...
    let total_bytes = if total_len > 0 {
        1 + (total_len * bits_per_digit - 1) / 8
    } else {
        0
    };
...
// TODO(robin): this is not really well defined for non radix 2^n ∀ n ∈ ℕ numbers
...
mod tests {
    ...
    fn padding_test() {
        ...
        assert_eq!(
            parse_num_padded("0b000000001000000"),
            Ok(vec![0, 0b1000000])
        );
        ...
        assert_eq!(
            parse_num_padded("0b00000010000000"),
            Ok(vec![0, 0b10000000])
        );
        assert_eq!(
            parse_num_padded("0b000000010000000"),
            Ok(vec![0, 0b10000000])
        );
        assert_eq!(
            parse_num_padded("0b0000000010000000"),
            Ok(vec![0, 0b10000000])
        );
        ...
        assert_eq!(
            parse_num_padded("0b00000000010000000"),
            Ok(vec![0, 0, 0b10000000])
        );
    }
    ...
    fn padding_mask_test() {
        ...
        assert_eq!(
            parse_num_mask_padded("0b000000001"),
            Ok((None, vec![0, 0b1]))
        );
        ...
        assert_eq!(
            parse_num_mask_padded("0b000000010"),
            Ok((None, vec![0, 0b10]))
        );
        assert_eq!(
            parse_num_mask_padded("0b0000000010"),
            Ok((None, vec![0, 0b10]))
        );
        ...
        assert_eq!(
            parse_num_mask_padded("0b000000100"),
            Ok((None, vec![0, 0b100]))
        );
        assert_eq!(
            parse_num_mask_padded("0b0000000100"),
            Ok((None, vec![0, 0b100]))
        );
        assert_eq!(
            parse_num_mask_padded("0b00000000100"),
            Ok((None, vec![0, 0b100]))
        );
        ...
        assert_eq!(
            parse_num_mask_padded("0b00001000"),
            Ok((None, vec![0b1000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b000001000"),
            Ok((None, vec![0, 0b1000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b0000001000"),
            Ok((None, vec![0, 0b1000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b00000001000"),
            Ok((None, vec![0, 0b1000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b000000001000"),
            Ok((None, vec![0, 0b1000]))
        );
        assert_eq!(parse_num_mask_padded("0b10000"), Ok((None, vec![0b10000])));
        assert_eq!(parse_num_mask_padded("0b010000"), Ok((None, vec![0b10000])));
        assert_eq!(
            parse_num_mask_padded("0b0010000"),
            Ok((None, vec![0b10000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b00010000"),
            Ok((None, vec![0b10000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b000010000"),
            Ok((None, vec![0, 0b10000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b0000010000"),
            Ok((None, vec![0, 0b10000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b00000010000"),
            Ok((None, vec![0, 0b10000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b000000010000"),
            Ok((None, vec![0, 0b10000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b0000000010000"),
            Ok((None, vec![0, 0b10000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b100000"),
            Ok((None, vec![0b100000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b0100000"),
            Ok((None, vec![0b100000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b00100000"),
            Ok((None, vec![0b100000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b000100000"),
            Ok((None, vec![0, 0b100000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b0000100000"),
            Ok((None, vec![0, 0b100000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b00000100000"),
            Ok((None, vec![0, 0b100000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b000000100000"),
            Ok((None, vec![0, 0b100000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b0000000100000"),
            Ok((None, vec![0, 0b100000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b00000000100000"),
            Ok((None, vec![0, 0b100000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b1000000"),
            Ok((None, vec![0b1000000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b01000000"),
            Ok((None, vec![0b1000000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b001000000"),
            Ok((None, vec![0, 0b1000000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b0001000000"),
            Ok((None, vec![0, 0b1000000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b00001000000"),
            Ok((None, vec![0, 0b1000000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b000001000000"),
            Ok((None, vec![0, 0b1000000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b0000001000000"),
            Ok((None, vec![0, 0b1000000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b00000001000000"),
            Ok((None, vec![0, 0b1000000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b000000001000000"),
            Ok((None, vec![0, 0b1000000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b10000000"),
            Ok((None, vec![0b10000000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b010000000"),
            Ok((None, vec![0, 0b10000000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b0010000000"),
            Ok((None, vec![0, 0b10000000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b00010000000"),
            Ok((None, vec![0, 0b10000000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b000010000000"),
            Ok((None, vec![0, 0b10000000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b0000010000000"),
            Ok((None, vec![0, 0b10000000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b00000010000000"),
            Ok((None, vec![0, 0b10000000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b000000010000000"),
            Ok((None, vec![0, 0b10000000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b0000000010000000"),
            Ok((None, vec![0, 0b10000000]))
        );
        assert_eq!(
            parse_num_mask_padded("0b100000000"),
            Ok((None, vec![0b1, 0]))
        );
        assert_eq!(
            parse_num_mask_padded("0b0100000000"),
            Ok((None, vec![0b1, 0]))
        );
        assert_eq!(
            parse_num_mask_padded("0b00100000000"),
            Ok((None, vec![0b1, 0]))
        );
        assert_eq!(
            parse_num_mask_padded("0b000100000000"),
            Ok((None, vec![0b1, 0]))
        );
        assert_eq!(
            parse_num_mask_padded("0b0000100000000"),
            Ok((None, vec![0b1, 0]))
        );
        assert_eq!(
            parse_num_mask_padded("0b00000100000000"),
            Ok((None, vec![0b1, 0]))
        );
        assert_eq!(
            parse_num_mask_padded("0b000000100000000"),
            Ok((None, vec![0b1, 0]))
        );
        assert_eq!(
            parse_num_mask_padded("0b0000000100000000"),
            Ok((None, vec![0b1, 0]))
        );
        assert_eq!(
            parse_num_mask_padded("0b00000000100000000"),
            Ok((None, vec![0, 0b1, 0]))
        );
        assert_eq!(
            parse_num_mask_padded("0b010000000"),
